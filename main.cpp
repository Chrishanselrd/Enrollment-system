...
void test1() {
  ...
  assert(es.getEnrolledCourses(1070) == "[CSS110, CSS173, CSS342]");
    string c342byLastName =
      "[Collins, Cassandra (1070), Evans, Juan (1401), Gonzalez, Holly (1223), Henderson, Daniel (1364), Taylor, Alexander (1986), Thompson, Christine (1386), Watson, Alex (1211)]";
assert(es.getClassListByLastName("CSS342") == c342byLastName);
  string c342byID =
      "[Collins, Cassandra (1070), Watson, Alex (1211), Gonzalez, Holly (1223), Henderson, Daniel (1364), Thompson, Christine (1386), Evans, Juan (1401), Taylor, Alexander (1986)]";
